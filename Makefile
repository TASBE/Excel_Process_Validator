...
ADDPATH=orig_dir=pwd();cd('$(PACKAGEDIR)');epv_set_path();cd(orig_dir)
...
help:
	...
	@echo "------------------------------------------------------------------"
	@echo "  install            to add Excel_Process_Validator to the Matlab and "
	@echo "                     GNU Octave search paths, using whichever is present"
	@echo "  uninstall          to remove Excel_Process_Validator from the Matlab and GNU"
	...
	@echo ""
	@echo "  install-matlab     to add Excel_Process_Validator to the Matlab search path"
	@echo "  install-octave     to add Excel_Process_Validator to the GNU Octave search path"
	@echo "  uninstall-matlab   to remove Excel_Process_Validator from the Matlab search path"
	@echo "  uninstall-octave   to remove Excel_Process_Validator from the GNU Octave search"
	@echo "                     path"
